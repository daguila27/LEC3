...
```{r}
#SE NECESITA SABER QUE CUAL ES EL MENOR INDICE DE ASISTENCIA
#QUE PORCENTAJE DE LOS EMPLEADOS ESTA BAJO LA MEDIA (< 80)
datos <- floor(rt(1000, 100, 80))/100
hist(datos,12)
```
...
```{r}
#EDAD DEL EMPLEADO MENOR Y EDAD DEL EMPLEADO MAYOR
edades <- rnorm(1000, 30)
```
...
```{r}
#SE NECESITA SABER LOS RANGOS DEL PUNTAJE
```
